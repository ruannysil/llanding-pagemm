  ...
  return (
    ...
    >
      ...
      >
        <hr
          style={{
            borderTop: "1px solid rgba(0, 0, 0, 0.292)",
        ...
        >
          <Text
            ...
            w={isMobile ? "100%" : "44%"}
          >
            Nossos pés estão no chão, mas nossas ambições descoladas estão acima
            das nuvens. Aqui está como nos movemos para satisfazer nossos
            clientes.
          </Text>
          ...
          <Text
            ...
            w={isMobile ? "100%" : "33%"}
          >
            Mumu Delivery © 2023 - Todos os direitos reservados - CNPJ:
            00.000.000/0000-00
          </Text>
        </Flex>
      </Flex>
